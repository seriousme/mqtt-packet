...
// This version uses NodeJS Buffer.allocUnsafe to allocate the buffer and Buffer.write for strings
...
class MQTT {
  ...
  generate (packet) {
    ...
    const result = Buffer.allocUnsafe(remainingLength + 2) // Placeholder for the result buffer
    let offset = 0
