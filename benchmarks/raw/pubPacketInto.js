...
// This version uses new Uint8Array() to allocate the buffer and TextEncoder.encodeInto for strings
...
class MQTT {
  ...
  generate (packet) {
    ...
    const topicLength = topic.length + 3
    ...
    offset += utf8Encoder.encodeInto(topic, result.subarray(offset))
    // Write the payload
